...
import br.com.treinaweb.calculadora.classes.*;
import br.com.treinaweb.calculadora.interfaces.*;

public class Calculadora {

	public CalculadorMatematico calculadora(int numero1, int numero2, String calculo) {
		if (calculo.equals("+")) {
